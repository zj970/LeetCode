...
/**
 * @author zj970
 * @since 2025-10-15 23:31:39
 */
public class P3471FindTheLargestAlmostMissingInteger {
    public static void main(String[] args) {
        Solution solution = new P3471FindTheLargestAlmostMissingInteger().new Solution();
    }
    ...
    class Solution {
        ...
        private int f(int[] nums, int begin, int end, int x) { for (int i = begin; i < end; i++) { if (nums[i] == x) { return -1; } } return x; }
}
