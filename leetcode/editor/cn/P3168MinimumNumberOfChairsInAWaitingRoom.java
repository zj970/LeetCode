...
/**
 * @author zj970
 * @since 2025-08-26 23:43:13
 */
public class P3168MinimumNumberOfChairsInAWaitingRoom {
    public static void main(String[] args) {
        Solution solution = new P3168MinimumNumberOfChairsInAWaitingRoom().new Solution();
    }
