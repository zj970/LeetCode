...
<ul> 
 <li>如果 <code>batteryPercentages[i]</code> <strong>大于</strong> <code>0</code>： </li>
</ul>
...
<div><div>Related Topics</div><div><li>数组</li><li>计数</li><li>模拟</li></div></div><br><div><li>👍 36</li><li>👎 0</li></div>