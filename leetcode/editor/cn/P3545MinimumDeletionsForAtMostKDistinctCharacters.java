...
// 
//
// Related Topics 贪心 哈希表 字符串 计数 排序 👍 9 👎 0
...
/**
 * @author zj970
 * @since 2025-10-29 22:56:24
 */
public class P3545MinimumDeletionsForAtMostKDistinctCharacters {
    public static void main(String[] args) {
        Solution solution = new P3545MinimumDeletionsForAtMostKDistinctCharacters().new Solution();
    }
