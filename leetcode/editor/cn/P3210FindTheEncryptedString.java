...
/**
 * @author zj970
 * @since 2025-08-31 22:51:58
 */
public class P3210FindTheEncryptedString {
    public static void main(String[] args) {
        Solution solution = new P3210FindTheEncryptedString().new Solution();
    }
    ...
    class Solution {
        public String getEncryptedString(String s, int k) {
            ...
            int len = s.length();
            for (int i = 0; i < len; i++) {
                buffer.append(s.charAt((i+k)%len));
            }
