...
// 
//
// Related Topics 贪心 数组 字符串 动态规划 👍 26 👎 0
...
/**
 * @author zj970
 * @since 2025-05-15 23:42:33
 */
public class P2900LongestUnequalAdjacentGroupsSubsequenceI {
    public static void main(String[] args) {
        Solution solution = new P2900LongestUnequalAdjacentGroupsSubsequenceI().new Solution();
    }
